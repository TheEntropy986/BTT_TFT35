...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0 //ThunderClap
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 2 //tried -1, 1, 2 here --ThunderClap
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 //tried 2, 1, -1 here --ThunderClap
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_3 3 //tried 3 here for Radek8 TFT35 alternate UART modification
...
#define CUSTOM_MACHINE_NAME "FrankenVinci V4.0" //ThunderClap
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //ThunderClap
#define Y_DRIVER_TYPE  TMC2209 //ThunderClap
#define Z_DRIVER_TYPE  TMC2209 //ThunderClap
...
#define E0_DRIVER_TYPE TMC2209 //ThunderClap
...
#define TEMP_SENSOR_BED 1000 //ThunderClap --Stock DV1.0Pro bed thermistor
...
#define HEATER_0_MAXTEMP 315 //ThunderClap
...
#define BED_MAXTEMP      100 //ThunderClap --Stock DV1.0Pro power supply/bed
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. ThunderClap
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. ThunderClap
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. ThunderClap
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 94.5 } //ThunderClap
...
#define INVERT_X_DIR true //ThunderClap
#define INVERT_Y_DIR false //ThunderClap
#define INVERT_Z_DIR true //ThunderClap
...
#define INVERT_E0_DIR true //ThunderClap
...
#define Z_HOMING_HEIGHT  4      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ThunderClap
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING  5      // (mm) Height to move to after homing Z --ThunderClap
...
#define X_BED_SIZE 200 //ThunderClap
#define Y_BED_SIZE 200 //ThunderClap
...
#define Z_MAX_POS 184 //ThunderClap
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR //ThunderClap --Enable this later
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 ThunderClap
...
//#define PREHEAT_1_TEMP_CHAMBER 35 //ThunderClap
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    100
//#define PREHEAT_2_TEMP_CHAMBER 35 //ThunderClap
 ...
 */
#define NOZZLE_PARK_FEATURE //ThunderClap

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_MAX_POS), 184 }
...
//
//#define REVERSE_ENCODER_DIRECTION //ThunderClap
...
//
//#define REVERSE_MENU_DIRECTION //ThunderClap
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //ThunderClap
